...
class MaterialUpdate(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MaterialUpdate:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MaterialUpdate:
        """Create an instance of MaterialUpdate from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MaterialUpdate.parse_obj(obj)

        _obj = MaterialUpdate.parse_obj({
            "name": obj.get("name"),
